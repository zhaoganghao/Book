...
<div class="content">
	<div class="header">
		<h1 class="page-title">回帖信息</h1>
	</div>
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="comInfBox">
				<form id="a_i_form"
				action="${pageContext.request.contextPath}/Servlet/MessageAction"
					method="post">
					...
					<table id="tabComInf" class="table table-bordered"
						...
						<thead>
							<tr>
								<th colspan="2" class="tabtitle">回帖信息</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td><textarea id="descr" name="cont"
