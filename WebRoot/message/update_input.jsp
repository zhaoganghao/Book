						...
						<tbody>
							...
							<tr>
								...
								<td><input id="name" name="name" type="text"
									id="textfield" onblur="strValidate('name',20)"  value="${data.name }"/><span></span>
								</td>
							</tr>
							<tr>
								<td>ISBN
								...
								<td><input id="ISBN" name="ISBN" type="text"
									onblur="strValidate('ISBN',20)" value="${data.ISBN }" /><span></span>
								</td>
							</tr>
							<tr>
								<td>作者
								...
								<td><input id="author" name="author" type="text"
									onblur="strValidate('author',5)"  value="${data.author }" /><span></span>
								</td>
							</tr>
							<tr>
								<td>数量
								...
								<td><input id="num" name="num" type="text"
									onblur="numValidate('num')"   value="${data.num }"/><span></span>
								</td>
							</tr>
							<tr>
								<td>描述
								...
								<td><textarea id="descr" name="descr"
										onblur="nullValidate('descr',10)" value="${data.descr }"></textarea><span></span>
								</td>
							</tr>
