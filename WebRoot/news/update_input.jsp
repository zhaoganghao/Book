			...
			<div class="comInfBox">
				...
				action="${pageContext.request.contextPath}/Servlet/BookAction"
					...
					<table id="tabComInf" class="table table-bordered"
						...
						<thead>
							<tr>
								<th colspan="2" class="tabtitle">新闻更新</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<input id="name" name="title" type="text"
									id="textfield" onblur="strValidate('name',20)" value="${data.title }" /><span></span>
								</td>
							</tr>
							<tr>
								<td>新闻内容
								...
								<td>
								<textarea id="descr" name="cont"
										onblur="nullValidate('descr',10)" value="${data.cont}" ></textarea><span></span>
								</td>
							</tr>
							<tr>
								<td>来源
								...
								<td><input id="author" name="source" type="text"
									onblur="strValidate('author',5)" value="${data.source }" /><span></span>
								</td>
							</tr>
							<tr>
								<td>作者
								...
								<td><input id="num" name="author" type="text"value="${data.author }" 
									 /><span></span>
								</td>
							</tr>
