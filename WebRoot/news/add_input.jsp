...
<div class="content">
	<div class="header">
		<h1 class="page-title">添加新闻信息</h1>
	</div>
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="comInfBox">
				<form id="a_i_form"
				action="${pageContext.request.contextPath}/Servlet/NewsAction"
					method="post">
					...
					<table id="tabComInf" class="table table-bordered"
						...
						<thead>
							<tr>
								<th colspan="2" class="tabtitle">添加新闻信息</th>
							</tr>
						</thead>
						<tbody>
							<tr>
							...
							<tr>
								...
								<td><input id="num" name="author" type="text"
									 /><span></span>
								</td>
							</tr>
